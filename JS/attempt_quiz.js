...
function showResult() {
  ...
  if (noneSelectedForAll) {
    ...
    if (scores.A >= 1) resultFields.push("Maker");
    if (scores.B >= 1) resultFields.push("Coder");
    if (scores.C >= 1) resultFields.push("Designer");
    if (scores.D >= 1) resultFields.push("Others");
